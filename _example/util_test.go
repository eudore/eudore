...
func TestUtilGet2(t *testing.T) {
	...
	t.Log(eudore.GetUint64("hx7", 6) == 6)
	...
	t.Log(eudore.GetFloat32("5xx", 6) == 6)
	...
	t.Log(eudore.GetFloat64("xxw5", 6) == 6)
	...
	t.Log(eudore.GetString(eudore.HandlerFunc(eudore.HandlerEmpty)))

	t.Log(eudore.GetStrings(nil))
	t.Log(eudore.GetStrings(TestUtilGet2))
	t.Log(eudore.GetStrings("1"))
	t.Log(eudore.GetStrings([]string{"1", "2", "3"}))
	t.Log(eudore.GetStrings([]int{1, 2, 3}))
	t.Log(eudore.GetStrings([]uint{1, 2, 3}))
	t.Log(eudore.GetStrings([]float32{1, 2, 3}))
	t.Log(eudore.GetStrings([]interface{}{1, 2, 3}))
}
...
func TestUtilGetString2(t *testing.T) {
	...
	t.Log(eudore.GetStringInt("a", 4) == 4)
	...
	t.Log(eudore.GetStringInt64("a", 4) == 4)
	...
	t.Log(eudore.GetStringUint("a", 4) == 4)
	...
	t.Log(eudore.GetStringUint64("a", 4) == 4)
	...
	t.Log(eudore.GetStringFloat32("a", 4) == 4)
	...
	t.Log(eudore.GetStringFloat64("a", 4) == 4)
	t.Log(eudore.GetStringFloat64("a") == 0)

	t.Log(eudore.GetString("1", "") == "1")
	t.Log(eudore.GetString("", "2") == "2")
	t.Log(eudore.GetString("3", "", "") == "3")
	t.Log(eudore.GetString("", "4", "") == "4")
	t.Log(eudore.GetString("", "", "5") == "5")
	t.Log(eudore.GetString("", "", "") == "")
}
