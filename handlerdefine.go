...
// NewHandlerFuncAnyError function converts func() (any, error), handles data Render and error.
...
// NewHandlerFuncContextError function converts func(Context) error and handles the returned error.
...
// NewHandlerFuncContextType function converts func(Context, T) handles data Bind.
...
// NewHandlerFuncContextTypeError function converts func(Context, T) any
// handles data Bind and error.
...
// NewHandlerFuncContextTypeAny function converts func(Context, T) any handles
// data Bind and data Render.
...
// NewHandlerFuncContextTypeAnyError function converts func(Context, T) (any, error)
// handles data Bind and data Render and error.
...
// NewHandlerAnyContextTypeAnyError function can match all extension objects.
//
...
// NewHandlerFuncContextMapAnyError function converts func(Context, map[string]any) (any, error),
...
// NewHandlerHTTPHandler function converts [http.Handler] type.
